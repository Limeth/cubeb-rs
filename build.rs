...
fn compile_c_source() {
    ...
    // TODO include dylib aswell
    gcc::Config::new()
                .file(project_dir.join("c/log.c"))
                .include(project_dir.join("cubeb/include/cubeb"))
                .include(project_dir.join("cubeb/build/exports"))
                .compile("libcubebrs.a");
}
